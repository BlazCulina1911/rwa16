...
{{--        {{ $request->copy()->format('[d-m-Y >> H:i]') }}--}}

{{--    </h1>--}}
{{--</div>--}}
<div class="container" style="padding:128px 16px">
    <h2 style="text-align: center; padding-bottom: 50px">Rezervacija uspješna s podacima</h2>
    <form method="POST" action="/reservations/store">
        ...
        <div class="row my-custom-row justify-content-center align-items-center w3-padding-20">
            ...
            <input name="date" class="col-sm-3" readonly="true" value="{{$request->format('d-m-Y')}}"></input>
        </div>
        <div class="row my-custom-row justify-content-center align-items-center w3-padding-20">
            <div class="col-sm-2">
                <div class="p-3 border bg-light">Vrijeme</div>
            </div>
            <input name="time" class="col-sm-3" readonly="true" value=" {{$request->format('H:i')}}"></input>
        </div>
        <div class="row my-custom-row justify-content-center align-items-center w3-padding-20">
            <div class="col-sm-2">
