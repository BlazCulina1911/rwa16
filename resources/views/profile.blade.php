...
<div class="container" style="padding:128px 16px">
    ...
    <div class="row my-custom-row justify-content-center align-items-center w3-padding-20">
        <div class="col-sm-2"><div class="p-3 border bg-light">Ime i Prezime</div></div>
        <input class="col-sm-3" disabled value="{{ Auth::user()->name }}"></input>
    </div>
    <div class="row my-custom-row justify-content-center align-items-center w3-padding-20">
        <div class="col-sm-2"><div class="p-3 border bg-light">Datum rođenja</div></div>
        <input type="date" id="birthday" name="birthday"class="col-sm-3" disabled></input>
    </div>
    <div class="row my-custom-row justify-content-center align-items-center w3-padding-20">
